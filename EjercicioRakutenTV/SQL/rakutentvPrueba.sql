...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-11-2018 a las 21:35:49
...
--
-- Base de datos: `rakutentvprueba`
--
DROP DATABASE IF EXISTS `rakutentvprueba`;
CREATE DATABASE IF NOT EXISTS `rakutentvprueba` DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish2_ci;
USE `rakutentvprueba`;
...
(3, 'rigofredo va al campo', '', '', '', '', '0000-00-00', '', '', 0, '0.00'),
(4, 'yisuscrist superestar', '', '', '', '', '0000-00-00', '', '', 0, '0.00'),
(5, 'roberto almendrón', '', '', '', '', '0000-00-00', '', '', 0, '0.00'),
(6, 'los pitufos', '', '', '', '', '0000-00-00', '', '', 0, '0.00');
...
(1, 2, 4, 1, '2018-11-16 20:20:16'),
(2, 2, 1, 4, '2018-11-16 20:18:48'),
(3, 1, 4, 1, '2018-11-16 19:05:34'),
(4, 2, 3, 5, '2018-11-16 20:18:33'),
(7, 4, 5, 4, '2018-11-16 19:21:32'),
(8, 2, 5, 4, '2018-11-16 20:18:17'),
(10, 4, 1, 1, '2018-11-16 19:37:28'),
(11, 5, 3, 2, '2018-11-16 20:15:26'),
(12, 1, 2, 2, '2018-11-16 20:20:46'),
(14, 5, 4, 2, '2018-11-16 20:16:05');
...
(2, 'juanito', '', '', '0000-00-00', '', -1, '', 1),
(3, 'pedro', '', '', '0000-00-00', '', -1, '', 1),
(4, 'afredo', '', '', '0000-00-00', '', -1, '', 1),
(5, 'rodrigo', '', '', '0000-00-00', '', -1, '', 1);
...
`idPelicula` int(11)
,`count(idPelicula)` bigint(21)
,`AVG(idInfoPuntuacion )` decimal(14,4)
);
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `valoracionglobalpelicula`  AS  select `puntuacion`.`idPelicula` AS `idPelicula`,count(`puntuacion`.`idPelicula`) AS `count(idPelicula)`,avg(`puntuacion`.`idInfoPuntuacion`) AS `AVG(idInfoPuntuacion )` from `puntuacion` group by `puntuacion`.`idPelicula` ;
